...
export { default as getClipboard } from './src/getClipboard';
...
export { default as openFileLocation } from './src/openFileLocation';
...
export { default as fullData } from './src/base/fullData';
...
export { default as debounce } from './src/event/debounce';
